  ...
  return (
    <Box boxShadow="rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" _hover={{boxShadow: "rgba(0, 0, 0, 0.35) 0px 5px 15px"}} borderRadius={10} cursor="pointer">
        ...
        <HStack spacing={10} padding={5}>
            <Image width={50} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScXyoZXpAWph9Vnu9_ZpWgNmn20W4hlBOn-5dLmFQuww8zSfnhRRNQW7B0RRuApO_PFwg&usqp=CAU"/> <Text>{raisedBy}</Text>
        </HStack>
