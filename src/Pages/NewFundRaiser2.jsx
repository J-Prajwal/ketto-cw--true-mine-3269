...
const NewFundRaiser2 = () => {
 ...
 useEffect(()=>{
  ...
  return (
    <Container overflowY="scroll"  backgroundColor="#3D3D3D" maxW="container.2xl" margin="auto" position="fixed"
     top={0}
    bottom={0}
    >
          ...
          {pageNumbers.page? <>
                ...
                <Text textAlign="left" color="grey" fontWeight={400}>How you first heard about ketto?</Text>
                    ...
                    <MenuList overflowY="scroll" height="30vh" width="32vw" direction="rtl">
                      <MenuItem    value="Cancer Treatment">Search Engine (Google,Yahoo,etc)</MenuItem>
                      <MenuItem   value="Accident treatment">Facebook, Instagram Ad/Post</MenuItem>
                      <MenuItem  value="Liver / Kidney transplant">Twitter Ad / Post</MenuItem>
                      <MenuItem  value="Heart operation">YouTube Ad / Post</MenuItem>
                      <MenuItem  value="Pre-mature baby care (NICU)">Brochure / Banner in Hospital</MenuItem>
                      <MenuItem  value="Medicines (Ongoing treatment)">Recommended by Doctor</MenuItem>
                      <MenuItem  value="Memorial (Patient expired)">Recommended by hospital Staff Member</MenuItem>
              ...
              <Container pb={10} m={5} maxW="container.md" margin="auto" textAlign="center">
              <Button colorScheme="teal" width="100%" variant="solid"  onClick={()=>{handlepages({
                        page:false,
                        page2:true,
                        page3:false
                      })}}>
                ...
                <Stack borderRadius={10} spacing={5} alignItems="center">
                  ...
                  <Menu >
                      <MenuButton width="100%" value='What will be the funds used for?' borderRadius="none" borderBottom="1px solid lightgrey" variant="flused"  as={Button} rightIcon={<ChevronDownIcon />}>
                  <Text textAlign="left" color="grey" fontWeight={400}>Type the medical condition here </Text>
                      </MenuButton>
                      <Container maxW="container.md">
                      <MenuList overflowY="scroll" height="30vh" width="32vw" direction="rtl">
                  ...
                  <InputGroup style={{zIndex:0}}>
                          ...
                          <Input  variant="flushed" outline="#30C9C8" placeholder='Hospital Name' />
                  ...
                  <InputGroup style={{zIndex:0}}>
                          ...
                          <Input  variant="flushed" outline="#30C9C8" placeholder='Enter your city' />
              ...
              <Button colorScheme="teal" width="100%" variant="solid"  onClick={()=>{handlepages({
                ...
                <Textarea padding={5} borderRadius={10} backgroundColor="#F5F5F5" variant="flushed" size="md"height="40vh" value={`Hi ,My name is ${name} and I am raising funds for my grandmother, Manju singh who is suffering from Liver cancer adults and is undergoing treatment at AIIMS Hospital, New Delhi . The family has done all it can to collect the total amount required for the treatment but Rs.6000 more is required to pay for all the medical expenses.
...
Thank you.`}/>
              ...
              <Container maxW="container.md" >
                <HStack borderRadius={10} padding={5} spacing={5} background="#F5F5F5">
                  <FaSmileBeam color="yellow"/>
                  <Text>Don’t worry! You can skip this step for now and add the story details and medical documents after submiting.</Text>
                </HStack>
              </Container>
              ...
              <Container fontSize="smaller" maxW="container.md" padding={10}>
                <HStack spacing={2}>
                  <Checkbox/>
                  <Text>I agree to Ketto's Terms of Use, service agreement ( USA and India ), Privacy Policy and Plans & Pricing. I acknowledge and confirm that the information provided above is true and correct to the best of my knowledge and belief and I agree to be liable if any of the above information is found to be false or misleading. I hereby give my consent for sharing it with regulatory authorities or disclosing it as may be required by law."</Text>
                </HStack>
              </Container>
              <Container pb={10} m={5} maxW="container.md" margin="auto" textAlign="center">
              <Button colorScheme="teal" width="100%" variant="solid" onClick={handleSubmitData}>
                  Submit
                </Button>
             </Container>
         ...
         <>
            ...
            <Button colorScheme="teal" width="100%" variant="solid"  onClick={()=>{handlepages({
              ...
              <Stack borderRadius={10} spacing={5} alignItems="center">
                  ...
                  <Container background="#EEEEEE"  textAlign="center" height="25vh" maxW="container.md" >
                      <Image margin="auto" pt="10vh" src="https://ketto.gumlet.io/assets/images/medical-fr/image-loader.jpg?w=480&dpr=1.0"/>
                  </Container>   

                  <Container p={2} background="#EEEEEE" maxW="container.md" >
                      <Button borderRadius="none" background="white">Choose A file</Button>
